...
echo ""
echo -e "${YLW}⚠ After scp, fix ownership so the runner (uid 999) can read it:${NC}"
echo ""
echo "  ssh root@\$(curl -s ifconfig.me) 'chown ${RUNNER_USER}:${RUNNER_USER} ${ARTIFACT_DIR}/dist-packages.tar.gz && chmod 644 ${ARTIFACT_DIR}/dist-packages.tar.gz'"
echo ""
